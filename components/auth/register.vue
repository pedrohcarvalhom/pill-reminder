  ...
  <CardContent>
    <form @submit="onSubmit">
      ...
      <div class="flex flex-col mt-4">
        <Button class=" bg-red-950 w-1/2 mx-auto" type="submit">Criar conta</Button>
        <Button variant="ghost" class="p-0 mt-1" @click="$emit('haveAccount')">Já possui uma conta? Faça login</Button>
      </div>
    </form>
  </CardContent>
</template>
