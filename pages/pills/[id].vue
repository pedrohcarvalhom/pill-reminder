    ...
    <div v-if="status == 'success'">
      ...
      <div class="mx-4">
        ...
        <div class="flex items-center justify-between my-8">
          ...
          <pills-edit v-else v-model="pillForm" @cancel="editingPill = false" @save="onSaveClicked" />
          <div v-if="!editingPill" class="flex gap-4">
        ...
        <pills-schedule-edit @on-edit-schedule="editing = true" @on-create="onCreatedHour" />
